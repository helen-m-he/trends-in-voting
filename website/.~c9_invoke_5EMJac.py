...
def graphs():
    if request.method == "GET":
        ...
        if graph == "democrat":
            return render_template("/PresElectDemPctByCounty.html")
        if graph == "republican":
            return render_template("/PresElectRepPctByCounty.html")
        if graph == "unemploy":
            return render_template("/UnemplPctByCounty.html")
        if graph == "poverty":
            return render_template("/PovertyPctByCounty.html")
        if graph == "education":
            return render_template("/BachelorPctByCounty.html")
